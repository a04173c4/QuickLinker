...
class CarouselDemoHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('عرض توضيحي للدوارة'),
        actions: [
          IconButton(
...
class BasicDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي بسيط')),
      body: Container(
...
class NoCenterDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<int> list = [1, 2, 3, 4, 5];
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي بسيط 2')),
      body: Container(
          child: CarouselSlider(
        options: CarouselOptions(
          disableCenter: true,
...
class ImageSliderDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لشريط تمرير الصور')),
      body: Container(
          child: CarouselSlider(
        options: CarouselOptions(),
        items: imgList
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          ' الصورة رقم ${imgList.indexOf(item)}',
...
class ComplicatedImageDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لشرائح الصور المعقدة')),
      body: Container(
        child: CarouselSlider(
          options: CarouselOptions(
            autoPlay: true,
...
class EnlargeStrategyDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لشرائح الصور المعقدة 2')),
      body: Container(
        child: CarouselSlider(
          options: CarouselOptions(
            autoPlay: true,
...
class _ManuallyControlledSliderState extends State<ManuallyControlledSlider> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('سلايدر يتم التحكم فيه يدويًا')),
...
class NoonLoopingDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لدوامة الظهيرة')),
      body: Container(
          child: CarouselSlider(
        options: CarouselOptions(
          aspectRatio: 2.0,
...
class VerticalSliderDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لدوارة السلايدر العمودية')),
      body: Container(
          child: CarouselSlider(
        options: CarouselOptions(
          aspectRatio: 2.0,
...
class FullscreenSliderDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لعرض دائري سلايدر على كامل الشاشة')),
      body: Builder(
        builder: (context) {
...
class OnDemandCarouselDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي دائري حسب الطلب')),
      body: Container(
...
class _CarouselWithIndicatorState extends State<CarouselWithIndicatorDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لدوارة مع وحدة تحكم المؤشر')),
...
class _PrefetchImageDemoState extends State<PrefetchImageDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لشريط تمرير الصور المسبقة')),
      body: Container(
          child: CarouselSlider.builder(
...
class _CarouselChangeReasonDemoState extends State<CarouselChangeReasonDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('سبب التغيير التجريبي')),
        body: Column(
          children: <Widget>[
            Expanded(
              child: CarouselSlider(
...
class KeepPageviewPositionDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('حافظ على عرض موضع الصفحة')),
...
class MultipleItemDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('عرض توضيحي لعناصر متعددة في شريحة واحدة')),
      body: Container(
          child: CarouselSlider.builder(
        options: CarouselOptions(
          aspectRatio: 2.0,
...
class EnlargeStrategyZoomDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('استراتيجية التكبير: عرض توضيحي للتكبير')),
      body: Container(
        child: CarouselSlider(
          options: CarouselOptions(
            aspectRatio: 2.0,
